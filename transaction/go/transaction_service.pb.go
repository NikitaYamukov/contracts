...
import (
	_go "github.com/NikitaYamukov/contracts/pagination/go"
...
type GetTransactionsRequest struct {
	...
	DateFrom      *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=date_from,json=dateFrom,proto3,oneof" json:"date_from,omitempty"` // filter from date
	DateTo        *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=date_to,json=dateTo,proto3,oneof" json:"date_to,omitempty"`       // filter to date
...
func (x *GetTransactionsResponse) GetPagination() *_go.Pagination {
	if x != nil {
		return x.Pagination
	}
	return nil
...
const file_transaction_service_proto_rawDesc = "" +
	"\n" +
	"\x19transaction_service.proto\x12\vtransaction\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17transaction_model.proto\x1a\x1bpagination/pagination.proto\"A\n" +
	...
	"\ftransactions\x18\x01 \x03(\v2\x1f.transaction.TransactionDetailsR\ftransactions\x126\n" +
	"\n" +
	"pagination\x18\x02 \x01(\v2\x16.pagination.PaginationR\n" +
	"pagination2\xd1\x02\n" +
	"\x12TransactionService\x12G\n" +
	"\aDeposit\x12\x1b.transaction.DepositRequest\x1a\x1f.transaction.TransactionDetails\x12I\n" +
	"\bWithdraw\x12\x1c.transaction.WithdrawRequest\x1a\x1f.transaction.TransactionDetails\x12I\n" +
	"\bTransfer\x12\x1c.transaction.TransferRequest\x1a\x1f.transaction.TransactionDetails\x12\\\n" +
	"\x0fGetTransactions\x12#.transaction.GetTransactionsRequest\x1a$.transaction.GetTransactionsResponseB?Z=github.com/NikitaYamukov/contracts/transaction/go;transactionb\x06proto3"
...
var file_transaction_service_proto_depIdxs = []int32{
	...
	6, // 4: transaction.GetTransactionsResponse.pagination:type_name -> pagination.Pagination
	0, // 5: transaction.TransactionService.Deposit:input_type -> transaction.DepositRequest
	1, // 6: transaction.TransactionService.Withdraw:input_type -> transaction.WithdrawRequest
	2, // 7: transaction.TransactionService.Transfer:input_type -> transaction.TransferRequest
	3, // 8: transaction.TransactionService.GetTransactions:input_type -> transaction.GetTransactionsRequest
	7, // 9: transaction.TransactionService.Deposit:output_type -> transaction.TransactionDetails
	7, // 10: transaction.TransactionService.Withdraw:output_type -> transaction.TransactionDetails
	7, // 11: transaction.TransactionService.Transfer:output_type -> transaction.TransactionDetails
	4, // 12: transaction.TransactionService.GetTransactions:output_type -> transaction.GetTransactionsResponse

...
func (x *DepositRequest) GetOperationId() string {
	if x != nil {
...
const file_account_service_proto_rawDesc = "" +
	...
	"\foperation_id\x18\x03 \x01(\tR\voperationId\"C\n" +
	...
	"\abalance\x18\x01 \x01(\x03R\abalance2\x9a\x06\n" +
	"\aAccount\x12l\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x1a.account.UpdateUserRequest\x1a\x16.google.protobuf.Empty\")\x82\xd3\xe4\x93\x02#:\x01*\x1a\x1eaccount/api/v1/users/{user_id}\x12<\n" +
	...
	"\n" +
	"GetBalance\x12\x1a.account.GetBalanceRequest\x1a\x1b.account.GetBalanceResponseB7Z5github.com/NikitaYamukov/contracts/account/go;accountb\x06proto3"
